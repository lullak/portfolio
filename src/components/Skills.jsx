      ...
      <article className="col-md-6 col-12">
        ...
        <div className="skills-grid">
          <div className="skill-card">
            <span className="skill-title">C# .NET</span>
          ...
          <div className="skill-card">
            <span className="skill-title">ASP .NET</span>
            <div className="small text-muted">
          ...
          <div className="skill-card">
            <span className="skill-title">Microservices, gRPC & REST Communication</span>
            <div className="small text-muted">
          ...
          <div className="skill-card">
            <span className="skill-title">Unit Testing & Integration Testing</span>
            <div className="small text-muted">
          ...
          <div className="skill-card">
            <span className="skill-title">Azure Cloud</span>
            <div className="small text-muted">
          ...
          <div className="skill-card">
            <span className="skill-title">Object-Oriented Analysis and Design</span>
            <div className="small text-muted">
          ...
          <div className="skill-card">
            <span className="skill-title">Data Communication and Security</span>
            <div className="small text-muted">
